		...
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form">
                    ...
                    <span class="login100-form-title p-b-43 mt-5">
						Buat Akun Baru
					</span>
					
					
					<div class="wrap-input100 validate-input" data-validate = "E-Mail : ex@abc.xyz">
                    ...
                    <div class="wrap-input100 validate-input">
						...
						<span class="focus-input100"></span>
						<span class="label-input100">Konfirrmasi Password</span>
					</div>
